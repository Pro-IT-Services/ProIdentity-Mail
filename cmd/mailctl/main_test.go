...
func TestCertHostnamesIncludesDiscoveryHostnames(t *testing.T) {
	got := certHostnames(app.Config{
		...
		DAVHostname:          "webmail.proidentity.cloud",
		MailHostname:         "mail.proidentity.cloud",
		AutoconfigHostname:   "autoconfig.proidentity.cloud",
		AutodiscoverHostname: "autodiscover.proidentity.cloud",
	})
	want := map[string]bool{
		"madmin.proidentity.cloud":       false,
		"webmail.proidentity.cloud":      false,
		"mail.proidentity.cloud":         false,
		"autoconfig.proidentity.cloud":   false,
		"autodiscover.proidentity.cloud": false,
	}
